        ...
        children: [
          ...
          Transform.translate(
            ...
            child: ClipPath(
              clipper: WaveClipper(),
              child: Container(
                  height: 80, color: const Color(0xFFA746AF)),
            ),
          ),
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  _field("Mot de passe", Icons.lock_outline,
                      isPassword: true,
              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          const Text("Photo de profil",
                              style: TextStyle(
                                  ...
                                  fontSize: 13)),
                          const Text("Appuie pour choisir",
                              style: TextStyle(
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: _field("Nom", Icons.person_outline,
                              controller: _nomCtrl)),
                  ...
                  const SizedBox(height: 14),
                  _gradientButton(
                      "Créer mon compte", _handleRegister),
                  const SizedBox(height: 14),
                  _orDivider(),
                  const SizedBox(height: 12),
                  _socialBtn("Google", "assets/google.png"),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: const TextStyle(
              color: Color(0xFFB0A0C0), fontSize: 13),
